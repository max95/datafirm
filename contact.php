...
<div class="col-md-8">
<textarea class="form-control" rows="9" placeholder="Votre texte ..."></textarea>
<button type="submit" class="btn btn-primary" style="background-color: Grey">Envoyer</button>
</div>
</div>
